package com.example.crud_java_app;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (taskAdapter == null) {
                    taskAdapter = new com.example.crud_java_app.TaskAdapter(MainActivity.this, taskList, new TaskAdapter.OnTaskClickListener() {
                        @Override
                        public void onUpdateClick(int position) {
                            com.example.crud_java_app.TaskModel updatedTask = taskList.get(position);
                            updateTask(updatedTask);
                        }

                        @Override
                        public void onDeleteClick(int position) {
                            com.example.crud_java_app.TaskModel deletedTask = taskList.get(position);
